...
from app.sound import Instrument
import subprocess
...
def main(
    ...
    background, img_coordinates = init_background(img_path, height, width)
    ...
    video.generate(partition, str(video_path), img_coordinates, timing)
